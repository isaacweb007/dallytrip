...
export async function onRequestGet({ request, env }) {
  ...
  const affId = env.DISCOVERCARS_AFFILIATE_ID || env.TRAVELPAYOUTS_MARKER || '';

  const baseLink = `https://www.discovercars.com/?a_aid=${encodeURIComponent(
    affId
  ...
  return json({ provider: 'discovercars-affiliate', count: results.length, results });
}
