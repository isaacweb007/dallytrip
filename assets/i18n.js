...
(function () {
  ...
  const DICT = {
    ...
    'admin.side.api':           { ko:'API 관리',       en:'API Manager',     ja:'API管理',        zh:'API 管理' },
    'admin.side.partners':      { ko:'제휴업체',       en:'Partners',        ja:'提携先',         zh:'合作伙伴' },
    'admin.side.wallet':        { ko:'토큰 지갑',      en:'Token Wallet',    ja:'トークンウォレット',zh:'代币钱包' },
    'admin.side.payouts':       { ko:'결제 대행 큐',   en:'Payouts Queue',   ja:'代行決済キュー',  zh:'代付队列' },

    // API page
    'admin.api.kicker':         { ko:'인프라',         en:'Infrastructure',  ja:'インフラ',       zh:'基础设施' },
    'admin.api.title':          { ko:'API 관리센터',   en:'API Manager',     ja:'API管理センター', zh:'API 管理中心' },
    'admin.api.endpoint':       { ko:'엔드포인트',     en:'Endpoint',        ja:'エンドポイント',  zh:'端点' },
    'admin.api.envVar':         { ko:'환경변수',       en:'Env Variable',    ja:'環境変数',       zh:'环境变量' },
    'admin.api.lastCheck':      { ko:'최근 확인',      en:'Last check',      ja:'最終確認',       zh:'最近检查' },
    'admin.api.healthy':        { ko:'정상',           en:'Healthy',         ja:'正常',           zh:'正常' },
    'admin.api.error':          { ko:'오류',           en:'Error',           ja:'エラー',         zh:'错误' },
    'admin.api.notConfigured':  { ko:'미설정',         en:'Not configured',  ja:'未設定',         zh:'未配置' },
    'admin.api.runCheck':       { ko:'전체 점검 실행', en:'Run health check',ja:'全件チェック実行',zh:'运行健康检查' },
    'admin.api.docs':           { ko:'문서',           en:'Docs',            ja:'ドキュメント',    zh:'文档' },

    // Partners page
    'admin.partners.kicker':    { ko:'수익원',         en:'Revenue sources', ja:'収益源',         zh:'收入来源' },
    'admin.partners.title':     { ko:'제휴업체 관리',  en:'Affiliate Partners',ja:'提携先管理',    zh:'合作伙伴管理' },
    'admin.partners.status':    { ko:'연동 상태',      en:'Integration',     ja:'連携状況',       zh:'集成状态' },
    'admin.partners.commission':{ ko:'수수료율',       en:'Commission',      ja:'手数料率',       zh:'佣金率' },
    'admin.partners.connected': { ko:'연동됨',         en:'Connected',       ja:'接続済み',       zh:'已连接' },
    'admin.partners.pending':   { ko:'가입 대기',      en:'Pending sign-up', ja:'登録待ち',       zh:'待注册' },
    'admin.partners.signup':    { ko:'가입하기',       en:'Sign up',         ja:'登録する',       zh:'注册' },
    'admin.partners.dashboard': { ko:'파트너 대시보드',en:'Partner dashboard',ja:'パートナー画面', zh:'合作伙伴控制台' },
    'admin.partners.estRevenue':{ ko:'예상 월 수익',   en:'Est. monthly revenue',ja:'月間想定収益',zh:'每月预估收入' },

    // Wallet page
    'admin.wallet.kicker':      { ko:'재무',           en:'Treasury',        ja:'財務',           zh:'金库' },
    'admin.wallet.title':       { ko:'$1 토큰 지갑 관리',en:'$1 Token Wallets',ja:'$1トークンウォレット管理',zh:'$1 代币钱包' },
    'admin.wallet.master':      { ko:'마스터 지갑',    en:'Master wallet',   ja:'マスターウォレット',zh:'主钱包' },
    'admin.wallet.pool':        { ko:'결제 풀',        en:'Payment pool',    ja:'決済プール',     zh:'支付池' },
    'admin.wallet.escrow':      { ko:'에스크로',       en:'Escrow',          ja:'エスクロー',     zh:'托管' },
    'admin.wallet.deposits':    { ko:'사용자 디파짓',   en:'User deposits',   ja:'ユーザー預入',   zh:'用户存款' },
    'admin.wallet.payouts':     { ko:'파트너 송금',    en:'Partner payouts', ja:'パートナー送金',  zh:'合作方付款' },
    'admin.wallet.balance':     { ko:'잔액',           en:'Balance',         ja:'残高',           zh:'余额' },
    'admin.wallet.address':     { ko:'지갑 주소',      en:'Wallet address',  ja:'ウォレットアドレス',zh:'钱包地址' },
    'admin.wallet.network':     { ko:'네트워크',       en:'Network',         ja:'ネットワーク',    zh:'网络' },
    'admin.wallet.addWallet':   { ko:'+ 지갑 추가',    en:'+ Add wallet',    ja:'+ ウォレット追加',zh:'+ 添加钱包' },
    'admin.wallet.send':        { ko:'송금',           en:'Send',            ja:'送金',           zh:'转账' },
    'admin.wallet.history':     { ko:'거래 내역',      en:'Transactions',    ja:'取引履歴',       zh:'交易历史' },
    'admin.wallet.type':        { ko:'유형',           en:'Type',            ja:'種類',           zh:'类型' },
    'admin.wallet.in':          { ko:'입금',           en:'In',              ja:'入金',           zh:'入账' },
    'admin.wallet.out':         { ko:'출금',           en:'Out',             ja:'出金',           zh:'出账' },
    'admin.wallet.from':        { ko:'보낸 곳',        en:'From',            ja:'送信元',         zh:'来自' },
    'admin.wallet.to':          { ko:'받는 곳',        en:'To',              ja:'宛先',           zh:'去往' },

    // Payouts queue page
    'admin.payouts.kicker':     { ko:'주문 처리',      en:'Order fulfillment',ja:'注文処理',      zh:'订单履约' },
    'admin.payouts.title':      { ko:'결제 대행 큐',   en:'Payouts Queue',   ja:'代行決済キュー',  zh:'代付队列' },
    'admin.payouts.desc':       { ko:'유저가 $1 토큰으로 결제하면 관리자가 제휴 API 업체에 대행 결제합니다.', en:'When users pay in $1 tokens, admin manually fulfills the booking by paying the partner API.', ja:'ユーザーが$1で支払い、管理者がパートナーAPIに代行決済します。', zh:'用户用 $1 支付后，管理员代为向合作伙伴 API 付款。' },
    'admin.payouts.user':       { ko:'유저',           en:'User',            ja:'ユーザー',       zh:'用户' },
    'admin.payouts.received':   { ko:'수령',           en:'Received',        ja:'受領',           zh:'已收' },
    'admin.payouts.toPay':      { ko:'대행 결제',      en:'To pay partner',  ja:'パートナー支払',  zh:'代付' },
    'admin.payouts.method':     { ko:'결제 수단',      en:'Method',          ja:'支払方法',       zh:'付款方式' },
    'admin.payouts.virtualCard':{ ko:'가상카드',       en:'Virtual card',    ja:'仮想カード',     zh:'虚拟卡' },
    'admin.payouts.manualPay':  { ko:'수동 결제',      en:'Manual',          ja:'手動',           zh:'手动' },
    'admin.payouts.autoPool':   { ko:'풀 자동',        en:'Auto pool',       ja:'プール自動',     zh:'池自动' },
    'admin.payouts.markPaid':   { ko:'결제완료 처리',  en:'Mark as paid',    ja:'支払済みに変更',  zh:'标记为已付' },
    'admin.payouts.book':       { ko:'예약 처리',      en:'Book on partner', ja:'パートナーで予約',zh:'在合作伙伴预订' },
    'admin.payouts.queued':     { ko:'대기',           en:'Queued',          ja:'待機',           zh:'排队中' },
    'admin.payouts.partnerPaid':{ ko:'파트너 결제완료',en:'Partner paid',    ja:'パートナー支払済', zh:'合作伙伴已付款' },
    'admin.payouts.completed':  { ko:'완료',           en:'Completed',       ja:'完了',           zh:'完成' },
    'admin.payouts.diff':       { ko:'마진',           en:'Margin',          ja:'マージン',       zh:'利润' },

    'demo.badge':               { ko:'데모 모드',      en:'DEMO',            ja:'デモ',           zh:'演示' },
    'demo.tooltip':             { ko:'결제는 곧 오픈됩니다. 지금은 모든 기능을 데모로 둘러보실 수 있어요.', en:'Payment opens soon. Browse everything in demo mode.', ja:'決済は近日公開。今はデモで全機能をご覧いただけます。', zh:'支付即将上线。现在可以演示模式查看所有功能。' },
